...
const { report } = require('../Schema.js');
...
const uploadReport = async () => {//TODO: req,res
    ...
    const function1 = async () => {
        ...
        const model = genAI.getGenerativeModel({
            ...
            systemInstruction: "If input is not related to medical diagnosis must respond with only {\n\"medicalQuery\":\"no\"\n}",
        });
    ...
        ];
        ...
        const result = await chatSession.sendMessage("the below information will provide you a data of test report file , fetch the parameters as json object and If data is not related to medical diagnosis must respond with only {\n\"medicalQuery\":\"no\"\n} \n"+data.text);
        ...
        const a = await report.findOne({_id:id}); //TODO need to add edge case here here
   ...
   // medobject1 = await function2(medobject);
